...
void forward_network(network *netp)
{
	...
	printf("i number %d\n",i);
        ...
        cpu_time_used = ((double) (end - start)) / CLOCKS_PER_SEC; // calculate the CPU 
       	//layer_size = net.input * sizeof(float);
        //printf("Layer size: %f MB\n",layer_size/1048576);
        printf("Time taken: %f seconds for layer %d\n", cpu_time_used,i);
    	//printf("Layer size: %f MB\n",layer_size/(1048576));
